...
import { Slider, Button, Switch, Input, Checkbox, InputOtp, Chip } from "@heroui/react";
...
export default function Autoclicker() {
    ...
    return (
        ...
        >
            ...
            <div className="relative rounded-[10px] overflow-hidden w-[552px] h-[478px]">
                <img src={mousePad} />
